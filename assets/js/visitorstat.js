...
for (step = 0; step < size; step++) {
    ...
    rqsts[step].open('GET', 'https://cntdabinishere.goatcounter.com/counter/TOTAL.json?start=' + todayisostring.slice(0, 10) + '&end=' + tomorrowisostring.slice(0, 10));
    rqsts[step].send();
}
...
today_cnt.open('GET', 'https://cntdabinishere.goatcounter.com/counter/TOTAL.json?start=' + today.toISOString().slice(0, 10));
today_cnt.send()
...
yesterday_cnt.open('GET', 'https://cntdabinishere.goatcounter.com/counter/TOTAL.json?start=' + yesterday.toISOString().slice(0, 10) + '&end=' + today.toISOString().slice(0, 10));
yesterday_cnt.send();
...
total_cnt.open('GET', 'https://cntdabinishere.goatcounter.com/counter/TOTAL.json');
total_cnt.send();
